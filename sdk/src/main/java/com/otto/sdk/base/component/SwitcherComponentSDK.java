package com.otto.sdk.base.component;//package app.clappingape.com.androidca.ui.component;
...
public class SwitcherComponentSDK {

    private Button[] buttons;
    public int checkedIndex;
    private SwitcherComponentSDK that;
    ...
    public SwitcherComponentSDK(final View container) {
    ...
    public interface OnSelectedChangeListener extends EventListener {
        void OnSelectedChange(SwitcherComponentSDK sender);
    }
}
