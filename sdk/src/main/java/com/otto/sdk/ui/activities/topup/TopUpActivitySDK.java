...
public class TopUpActivitySDK extends BaseActivitySDK {
    ...
    private void initComponent() {
        ...
        String phone = CacheUtil.getPreferenceString(IConfigSDK.SESSION_PHONE, TopUpActivitySDK.this);
    ...
    private void initContent() {
        btnBottom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TopUpActivitySDK.this, DashboardActivitySDK.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                TopUpActivitySDK.this.startActivity(intent);
            }
        });
    }
